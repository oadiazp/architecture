...
Metadata.Viewport = Ext.extend(Ext.Viewport, {
    layout: 'border',
    initComponent: function() {
        this.items = [
            {
				...
				loader: new Ext.tree.TreeLoader ({url: 'main/load'}),
                region: 'west',
                rootVisible: false,
                listeners: {
        ...
        Metadata.Viewport.superclass.initComponent.call(this);
    }
});

new Metadata.Viewport ();
