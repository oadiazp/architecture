<?php
	...
	$config ['paths']['js'][] = $config['co_path']  . 'public/js/ciext/codemirror/';
	$config ['paths']['js'][] = $config['co_path']  . 'public/js/ciext/codemirror/CodeMirror-0.63/js';
    ...
    $config['title'] = 'Manejador Web de Ficheros';
    ...
    //Xmpp
    $config ['xmpp']['client']['url'] 	   = 'http://localhost/xmpp-httpbind';
    $config ['xmpp']['client']['username'] = 'a@zco';
    $config ['xmpp']['client']['password'] = 'a';

    $config ['xmpp']['server']['domain']   = 'zclaptop';
    $config ['xmpp']['server']['port'] 	   = 5222;
    $config ['xmpp']['server']['username'] = 'b';
    $config ['xmpp']['server']['password'] = 'b';
